      ...
      <div className={cn("size-full ring-2 ring-accent rounded-none flex flex-col justify-between bg-card")}>
        <div className="flex flex-row gap-4 items-center text-sm px-4 h-30 ring-2 ring-accent max-h-1/9">
          ...
          <div className="flex flex-col gap-0">
            ...
            {vidMeta.alias && <p className="text-xxs xs:text-xs portrait:sm:text-lg italic">{vidMeta.alias}</p>}
            <p className="text-xxs xs:text-xs portrait:sm:text-lg italic">{`il y a ${Math.round(vidMeta.hashtag.length / 10)} jours`}</p>
          </div>
        </div>
        ...
        <div className="w-full overflow-auto flex-1 flex flex-col">
          ...
          {vidMeta.index === 4 && (
            <div className="text-sm portrait:sm:text-lg text-justify p-4 flex-1 flex flex-col items-center justify-center gap-2">
              <p className="text-justify m-auto">
                Les ateliers autour de <strong className="italic">smart.phonics</strong> s&apos;adressent en premier lieu à un public adolescent et
                jeunes adultes (collégiens dès la 4ème, lycéens, élèves en Conservatoires, en écoles d’art et design, etc.), très sensibles aux
                questions nombreuses, complexes et ambiguës que pose l&apos;utilisation du smartphone et des réseaux sociaux.
                <br />
                <br />
              ...
              <p className="text-justify m-auto">
                Elles peuvent avoir lieu en amont ou en aval de la représentation de <strong className="italic">smart.phonics</strong>. Ceci est à
                établir avec les enseignants, en fonction des possibilités horaires des classes et des lieux d&apos;accueil.
              </p>
                  ...
                  <DialogContent className="sm:max-w-[425px] max-h-full overflow-scroll" onOpenAutoFocus={(e) => e.preventDefault()}>
                    <DialogHeader>
                      ...
                      <DialogDescription className="text-justify">
                        ...
                        <br />
                        <br />
                        Cette action a permis de présenter la création aux élèves (ses aspects technologiques et proprement musicaux). Elle a
                        également permis d’aborder (puisque c’est le cœur narratif du projet <strong className="italic">smart.phonics</strong> !) les
                        questions liées à l&apos;usage omniprésent des smartphones et des réseaux sociaux. Durant la deuxième séance, des ateliers de
                        pratique artistique ont été réalisés avec les collégiens ; ateliers pendant lesquels ils ont pu découvrir ce qu’est un
                        &quot;échantillonneur sonore numérique&quot; et manipuler cet instrument directement sur leurs smartphones. Ils ont aussi pu
                        réaliser un &quot;faux réseau social&quot; de type Instagram à partir de leurs propres images. Après deux interventions en
                        classe, les collégiens ont pu assister au spectacle, puis échanger avec les artistes.
                      </DialogDescription>
                    </DialogHeader>
