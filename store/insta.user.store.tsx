...
type instaUserStoreType = {
  vidMeta: { name: string; link: string; linkname: string; description: string; hashtag: string }[];
};
  ...
  vidMeta: [
    {
      ...
      hashtag:
        "##web #digitalarts #electronicmusic #collaborativeart #glitches #technomusic #videoart #analog #whales #sharedcreation #technology #socialnetworks #climaticdisasters #filter #nofilter #sequencing #storms  #hifreq #lofreq #hires #hacking #internet #crashes #cats",
    },
    {
      name: "Romain AL.",
      ...
      hashtag: "#Artiste visuel #Développeur Web #VJ #Réalisateur #Guitariste #Photographe #Shader",
    },
    {
      name: "Nicolas CANOT",
      link: "",
      ...
      hashtag: "#Compositeur #Improvisateur #Modulariste #Artiste digital #Développeur numérique #Enseignant installé à Reims-France.",
    },
  ],
};
